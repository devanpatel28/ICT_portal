...
@override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(onPressed: ()=>Get.off(StudentScreen()), icon: Icon(Icons.arrow_back_rounded)),
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              Get.off(LoginPage(),curve: Curves.easeOutBack,duration: Duration(seconds: 2));
                            },
